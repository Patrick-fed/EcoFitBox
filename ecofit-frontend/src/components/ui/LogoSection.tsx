...
export function LogoSection({ subtitle }: LogoSectionProps) {
  return (
    <div className="flex flex-col items-center">
      ...
      <h1 className="text-7xl font-black text-[#3C5A1A] tracking-tight mt-2">ECOFIT</h1>
      <div className="flex items-center gap-4 mt-1">
        <div className="w-24 h-[3px] bg-[#5B7B3A]" />
        <span className="text-3xl font-bold text-[#3C5A1A] tracking-widest">BOX</span>
        <div className="w-24 h-[3px] bg-[#5B7B3A]" />
      </div>
      {subtitle && (
